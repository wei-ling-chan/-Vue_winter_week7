          ...
          <div class="modal-body">
            <div class="row">
              <div class="col-sm-4">
                ...
                <div
                  v-for="(image, key) in template.imagesUrl"
                  class="mb-3"
                  :key="key"
                >
                  <input
                    ...
                    v-model="template.imagesUrl[key]"
                    placeholder="請輸入連結"
                  />
                  <div>
                  ...
                  <button
                    ...
                    @click="template.imagesUrl.splice(key, 1)"
                  >
                    移除
                  </button>
                </div>
              ...
              <div class="col-sm-8">
                ...
                <div class="row">
                  <div class="mb-3 col-md-6">
                    ...
                    <input id="category" type="text" class="form-control"
                           placeholder="請輸入分類" v-model="template.category">
                  </div>
                  <div class="mb-3 col-md-6">
                ...
                <div class="row">
                  ...
                  <div class="mb-3 col-md-6">
                    ...
                    <input id="price" type="number" min="0" class="form-control"
                           placeholder="請輸入售價"  v-model="template.price">
                  </div>
                </div>
                <hr>
                ...
                <div class="mb-3">
                  ...
                  <textarea id="description" type="text" class="form-control"
                            placeholder="請輸入產品描述" v-model="template.description">
                  </textarea>
                </div>
                <div class="mb-3">
                  <label for="content" class="form-label">說明內容</label>
                  <textarea id="description" type="text" class="form-control"
                            placeholder="請輸入說明內容" v-model="template.content">
                  </textarea>
                </div>
                <div class="mb-3">
                  <div class="form-check">
                    <input id="is_enabled" class="form-check-input" type="checkbox"
                           :true-value="1" :false-value="0" v-model="template.is_enabled">
